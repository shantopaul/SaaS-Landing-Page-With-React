        ...
        >
          ...
          <motion.div className="space-y-8">
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              >
                <span className="px-4 py-2 bg-gradient-light rounded-full text-primary font-medium text-sm border border-gray-200">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-gray-300 text-gray-900 font-semibold rounded-lg hover:bg-gray-50 flex items-center justify-center gap-2 transition-fast"
              >
            ...
            {/* Stats */}
            <motion.div variants={itemVariants} className="flex gap-8 pt-8 border-t border-gray-200">
              {[
          ...
          >
            ...
            <div className="relative w-full h-96">
              ...
              <motion.div
                ...
                className="absolute inset-0 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-soft-lg border border-gray-200 overflow-hidden"
              >
              ...
              <motion.div
                ...
                className="absolute -top-8 -right-12 w-40 glass rounded-xl p-4 shadow-glass border border-white/20"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-8 -left-12 w-40 glass rounded-xl p-4 shadow-glass border border-white/20"
              >
                ...
                <p className="text-xs text-gray-600 mt-1">Team sync</p>
              </motion.div>
            </div>
          </motion.div>
        </motion.div>
