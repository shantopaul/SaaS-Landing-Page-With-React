        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 bg-white dark:bg-dark-card rounded-3xl border border-gray-100 dark:border-white/5 shadow-soft-lg relative"
            >
              <div className="absolute top-6 right-8 text-primary/10 dark:text-primary/5">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8 relative z-10 italic">
                "{testimonial.content}"
              </p>
